...
(function ($, Drupal, Backbone) {
  ...
  Drupal.custom_list_default.FilterForm = Backbone.View.extend({
    ...
    initialize: function () {
      ...
      this.filterOptions = JSON.parse($('.custom-list-default__default-source-list-plugin__options').val());
    ...
    addFilter: function (event) {
      ...
      $.each(me.filterOptions.filter, function (filter_id) {
        $.each(me.filterOptions.filter[filter_id].operators, function (operator_id) {
          collection.create({
            filter_id: filter_id,
